...
export default function Slava() {
    ...
    const handler = async () => {
        try {
            const response = await axios.get('http://localhost:5000/rehabilitation')
                .then(response => {
        ...
        <>
            <div className="main-sizm">
                <p className="main-qxv">
                    ...
                    <p className="main-dcv" onClick={e => toggleCollapse(5)}>
                        <h3 className='title-sizm'>
                            {data.title4}
                            <p style={{ float: 'right', marginRight: '30px' }}>
                                {isCollapsed5 ? '+' : '-'}
                    ...
                    <p className="main-dcv" onClick={e => toggleCollapse(6)}>
                        <h3 className='title-sizm'>
                            {data.title5}
                            <p style={{ float: 'right', marginRight: '30px' }}>
                                {isCollapsed6 ? '+' : '-'}
